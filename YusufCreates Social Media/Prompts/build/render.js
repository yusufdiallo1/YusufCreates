/**
 * Renders each Prompts carousel to 1080x1350 PNGs via headless Chromium.
 *
 ...
 *
 * Output: Prompts/posts/<slug>/<slug>-<n>.png
 *
...
(async () => {
  ...
  await browser.close();
  console.log(`\n${count} slides written to "Prompts/posts/" at ${W}x${H}`);
